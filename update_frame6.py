...
with open(r'C:\Users\yeons\.gemini\antigravity\brain\a0de5db8-fcea-4037-b511-d410ef8bf03d\.system_generated\steps\1388\output.txt', 'r', encoding='utf-8') as f:
    text = f.read()
...
# Fix the top-level class to match the old Frame 6 wrapper (absolute, top, left, width, height)
...
old_frame6_match = re.search(r'<div[^>]*?data-node-id="125:676"[^>]*?>.*?data-node-id="125:679"', shop_html, re.DOTALL)
if old_frame6_match:
    old_text = old_frame6_match.group(0)
    ...
    shop_html = shop_html.replace(old_text, new_frame6)
    with open('shop.html', 'w', encoding='utf-8') as f:
        f.write(shop_html)
    print("Successfully replaced Frame 6")
else:
    print("Could not find old Frame 6 in shop.html")
